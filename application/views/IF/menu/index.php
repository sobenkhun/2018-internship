    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item navHover">
        <a class="nav-link" href="<?php echo base_url();?>Welcome_IF/company">
          <b class="colorTextMenu">  Company</b>
        </a>
      </li>
      <li class="nav-item navHover">
        <a class="nav-link" href="<?php echo base_url();?>Welcome_IF/supervisor">
          <b class="colorTextMenu">  Supervisor</b>
        </a>
      </li>
      <li class="nav-item navHover">
        <a class="nav-link" href="<?php echo base_url();?>Welcome_IF/tutor">
          <b class="colorTextMenu">  Tutor</b>
        </a>
      </li>
      <li class="nav-item navHover">
        <a class="nav-link" href="<?php echo base_url();?>Welcome_IF/student">
          <b class="colorTextMenu">  Student</b>
        </a>
      </li>
      <li class="nav-item navHover">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <div class="col-md-6 text-center">
          ...
          <h5 class="modal-title">ERO username</h5>
        </div>
