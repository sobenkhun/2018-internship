...
<nav class=" navbar navbar-expand-lg navbar-light  color">
  <a class="navbar-brand" href="<?php echo base_url();?>Welcome_IF/home">
      <img class="logo" src="<?php echo base_url();?>assets/images/logo_L.png" alt="Logo" style="width:150px;">
    </a>
  ...
  <div class=" collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav">
      <li class="nav-item active ">
        <a class="nav-link" href="#"><b style="padding: 0 10px 0 0;" class="colorTextMenu">  
    <i  class="mdi mdi-email" style="font-size: 20px; margin-bottom: 10px; margin-right: 50px;"></i>
        Username </b></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><b class="colorTextMenu"> Logout </b><img src="icons8-shutdown-24.png" alt=""></a>
      </li>
    </ul>
  </div>
</nav><br><br>