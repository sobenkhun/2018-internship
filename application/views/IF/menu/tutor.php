  ...
  <div class=" collapse navbar-collapse" id="navbarSupportedContent" style="font-family: sans-serif;">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active ">
        <a class="nav-link" href="<?php echo base_url();?>tutorDas/companyDas"><b class="colorTextMenu">  Company</b></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url();?>tutorDas/supervisorDas"><b class="colorTextMenu">  Supervisor</b></a>
      </li>
      
      <li class="nav-item active ">
        <a class="nav-link" href="<?php echo base_url();?>tutorDas/studentDas"><b class="colorTextMenu">  Student</b></a>
      
      <li class="nav-item active ">
        <a class="nav-link" href="<?php echo base_url();?>tutorDas/calendar"><b class="colorTextMenu">Calendar   <i class="mdi mdi-book" style="font-size:12px; margin-top: 50px;"></i></b></a>
    ...
    <ul class="navbar-nav">
             <li class="nav-item">
              <div class="dropdown">
               <a href="#" class="nav-link active"  data-toggle="dropdown" aria-expanded="false">
                 <i   class="mdi mdi-email iconEmail"> </i>          
               </a>
             ...
             <li class="nav-item">
              <div class="dropdown">
               <a href="#" class="nav-link active "  data-toggle="dropdown" aria-expanded="false">
                 <i  class="mdi mdi-bell iconBell"> </i>          
               </a>
                <div class="dropdown-menu ">
                    <div class="dropdown-body">
                     <a class="dropdown-item text-dark" href="#"><img class="logo" src="<?php echo base_url();?>assets/images/logo.png"><strong>Rith.Nhil</strong> <br>conmment on <strong>Toch.Ban</strong></b></a>
             ...
             <li class="nav-item ">
               <a class="nav-link" href="#">       
                 <b class="colorTextMenu">  
                   <span> Username </span><i class="mdi mdi-account-circle iconAccount"></i> 
                 </b>
               </a>
             </li>
             <li class="nav-item">
               <a class="nav-link" href="<?php echo base_url();?>Welcome_IF">
                 <b class="colorTextMenu"> 
                   <span> Logout </span> <i class="mdi mdi-login iconAccount"></i> 
                 </b>
               </a>
             </li>
           </ul>
