...
<nav class=" navbar navbar-expand-lg navbar-light  color">
  ...
  <div class=" collapse navbar-collapse" id="navbarSupportedContent" style="font-family: sans-serif;">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url();?>tutorDas/tutorList"><b class="colorTextMenu">  Tutor</b></a>
      </li>
      <li class="nav-item active ">
      ...
      <li class="nav-item active ">
        <a class="nav-link" href="<?php echo base_url();?>tutorDas/calendar"><b class="colorTextMenu">Calendar   </b></a>
