...
<div class="container">
      ...
      <table id="example" class="table table-striped table-bordered">
       ...
       <tbody>
        <tr>
          ...
          <td>Phnom Penh</td>
          <td>
           <a href="<?php echo base_url();?>Welcome_IF/detailCompany"><span class="mdi mdi-eye mdi-24px text-info"></span></a>
  ...
  <tr>
    ...
    <td>Phnom Penh</td>
    <td>
     <a href="detail.html"><span class="mdi mdi-eye mdi-24px text-info"></span></a>
