		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header bg-primary">
					<h3 class="text-center text-white">Create New Superviser</h3>
				</div>
				<div class="body">
					<div class="row">
						...
						<div class="col-md-4"><br>
							...
							<a class="link" href="#" >Choose Profile Picture</a>
						</div>
						<div class="col-md-6">
							<form action="/action_page.php">
								<table><br>
									...
									<tr>
										<td><a href="superviser.html"><button type="button" class="btn btn-outline-success">Save</button></a></td>
										<td><a href="superviser.html"><button type="button" class="btn btn-outline-danger float-right">Cancel</button></a></td>
									</tr>
								</table><br>
							</form>
						</div>
