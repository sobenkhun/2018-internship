...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url();?>assets/images/logo_login.png" type="image/x-icon">
  <!-- style personal -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/css/if_style.css">
