	...
	<div class="row">
		<div class="col-lg-12">
			<div id="accordion">
				...
				<!-- ================= -->
				<div class="card">
					<div class="card-header text-center bg-info" id="headingSex" data-toggle="collapse" data-target="#sexthday" aria-expanded="true" aria-controls="sexthday">
						<h5 class="mb-0 text-white"><strong>Monday</strong></h5>
					</div>

					<div id="sexthday" class="collapse" aria-labelledby="headingSex" data-parent="#accordion">
						<div class="card-body">
							<table class="table table-bordered table-hover" id="tableWorkLog">
								<tbody class="bg-white">
									<tr>
