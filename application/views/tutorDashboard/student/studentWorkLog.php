		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item dropup">
					<a href="#" class="nav-link text-white dropdown-toggle" id="month1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">June</a>
					<div class="dropdown-menu text-right" aria-labelledby="month1">
						<a class="dropdown-item" href="#">Week1</a>
						<a class="dropdown-item" href="#">Week2</a>
						<a class="dropdown-item" href="#">Week3</a>
						<a class="dropdown-item" href="#">Week4</a>
					</div>
				</li>
				<li class="nav-item dropup">
					<a href="#" class="nav-link text-white dropdown-toggle" id="month2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">July</a>
					<div class="dropdown-menu text-right" aria-labelledby="month2">
						<a class="dropdown-item" href="#">Week1</a>
						<a class="dropdown-item" href="#">Week2</a>
						<a class="dropdown-item" href="#">Week3</a>
						<a class="dropdown-item" href="#">Week4</a>
				...
				<li class="nav-item dropup">
					<a href="#" class="nav-link text-white dropdown-toggle" id="month3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">August</a>
					<div class="dropdown-menu text-right" aria-labelledby="month3">
						<a class="dropdown-item" href="#">Week1</a>
						<a class="dropdown-item" href="#">Week2</a>
						<a class="dropdown-item" href="#">Week3</a>
						<a class="dropdown-item" href="#">Week4</a>
				...
				<li class="nav-item dropup">
					<a href="#" class="nav-link text-white dropdown-toggle" id="month4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">September</a>
					</button>   
					<div class="dropdown-menu text-right" aria-labelledby="month4">
						<a class="dropdown-item" href="#">Week1</a>
						<a class="dropdown-item" href="#">Week2</a>
						<a class="dropdown-item" href="#">Week3</a>
						<a class="dropdown-item" href="#">Week4</a>
